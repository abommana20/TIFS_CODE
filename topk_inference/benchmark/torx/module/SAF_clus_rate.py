...
class SAF(nn.Module):
    ...
    def __init__(self, G_shape, p_SA00=0.1, p_SA01=0.1, p_SA10=0.1, p_SA11=0.1, G_SA00=3e-3, G_SA01=1e-3, G_SA10=2e-3, G_SA11=3e-6, dist = "cluster", fault_rate = 0.05, device=None, config_path=None, layer_count=None, neg=0):
