        ...
        for attack_name in attack_names:
            for tile in tile_configs:
                for flp_config in flp_configs:
                    ...
                    path = original_directory + f'/results3d/{attack_name}/{model_name}/{tile}/{flp_config}'
            ...
            for tile in tile_configs:
                for flp_config in flp_configs:
                    ...
                    command = [
                        ...
                        '--cuda', 'cuda:0',
                        '--fault_dist', 'uniform',
                        '--path', f'{original_directory}/results3d/{attack_name}/{model_name}/{tile}/{flp_config}/new_tile_temp_{mode}.pt'
                    ]
                    output_file_path = f"{original_directory}/results3d/{attack_name}/{model_name}/{tile}/{flp_config}/accuracy_output_{mode}.txt"
