    ...
    for model_name in model_names:
        ...
        for attack_name in attack_names:
            for config in configs:
                ...
                path = original_directory + f'/results_spe/{attack_name}/{model_name}/{config*100}_{(1-config)*100}'
        ...
        for attack_name in attack_names:
            for config in configs:
                ...
                command = [
                    ...
                    '--cuda', 'cuda:0',
                    '--fault_dist', 'uniform',
                    '--path', f'{original_directory}/results_spe/{attack_name}/{model_name}/{config*100}_{(1-config)*100}/new_tile_temp_{mode}.pt'
                ]
                output_file_path = f"{original_directory}/results_spe/{attack_name}/{model_name}/{config*100}_{(1-config)*100}/accuracy_output_{mode}.txt"
