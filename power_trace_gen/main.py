    ...
    for model_name in model_names:
        ...
        for attack_name in attack_names:
            for config in configs:
                ...
                path = original_directory + f'/results/{attack_name}/{model_name}/{config}'
        ...
        for attack_name in attack_names:
            for config in configs:
                ...
                command = [
                    ...
                    '--cuda', 'cuda:0',
                    '--fault_dist', 'uniform',
                    '--path', f'{original_directory}/results/{attack_name}/{model_name}/{config}/new_tile_temp_{mode}.pt'
                ]
                output_file_path = f"{original_directory}/results/{attack_name}/{model_name}/{config}/accuracy_output_{mode}.txt"
