...
../../scripts/split_grid_steady.py outputs/example.grid.steady 6 8 8
../../scripts/grid_thermal_map.py floorplan2.flp outputs/example_layer2.grid.steady 8 8 outputs/layer2.png
../../scripts/grid_thermal_map.pl floorplan2.flp outputs/example_layer2.grid.steady 8 8 > outputs/layer2.svg
